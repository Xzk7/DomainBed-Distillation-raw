...
from domainbed.backbone import get_backbone
...
#
#     keys = ["/home/zekaixu/DG/code/miro/config.yaml"]
#     keys = [open(key, encoding="utf8") for key in keys]
#     hparams = Config(*keys, default=hparams)
#     hparams["pretrained"] = False
#     teacher_featurizer = URFeaturizer(
#         (3,224,224), hparams, freeze="all", feat_layers=hparams.feat_layers
#     )
#     input = torch.randn(2,3,224,224)
#     _, inter_feats1 = teacher_featurizer(input, ret_feats=True)
#
#     hparams["model"] = "resnet18"
#     hparams["pretrained"] = True
#     student_featurizer = URFeaturizer(
#         (3, 224, 224), hparams, freeze="all", feat_layers=hparams.feat_layers
#     )
#     input = torch.randn(2, 3, 224, 224)
#     _, inter_feats2 = student_featurizer(input, ret_feats=True)
#
#     for f1, f2 in zip(inter_feats1, inter_feats2):
